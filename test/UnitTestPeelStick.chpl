...
proc testMessageLayer(substr, n, minLen, maxLen) throws {
  ...
  var (_,loname) = loAttribs.splitMsgToTuple(2);
  var (_,lvname) = lvAttribs.splitMsgToTuple(2);
  var (_,roname) = roAttribs.splitMsgToTuple(2);
  var (_,rvname) = rvAttribs.splitMsgToTuple(2);
  ...
  var (_,rtoname) = rtoAttribs.splitMsgToTuple(2);
  var (_,rtvname) = rtvAttribs.splitMsgToTuple(2);
